...
for train_index, test_index in kf.split(X):
    ...
    concat1 = layers.Average()([hA_1, hB_1])
    hA_2 = layers.Dense(20, activation="relu")(concat1)
    hB_2 = layers.Dense(20, activation="relu")(hA_2)
    concat2 = layers.Average()([hA_2, hB_2])
    hA_3 = layers.Dense(20, activation="relu")(concat2)
    hB_3 = layers.Dense(20, activation="relu")(hA_3)
    concat3 = layers.Average()([hA_3, hB_3])
    hA_4 = layers.Dense(20, activation="relu")(concat3)
...
np.save('predict_arr1.npy', predict_arr)
