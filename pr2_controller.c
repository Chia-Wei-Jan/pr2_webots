...
static void initialize_devices() {
  ...
  rotation_motors[FL_ROTATION] = robot.getDevice("fl_caster_rotation_joint")
  rotation_motors[FR_ROTATION] = robot.getDevice("fr_caster_rotation_joint")
  rotation_motors[BL_ROTATION] = robot.getDevice("bl_caster_rotation_joint")
  rotation_motors[BR_ROTATION] = robot.getDevice("br_caster_rotation_joint")
  for (i = FL_ROTATION i <= BR_ROTATION ++i)
    rotation_sensors[i] = wb_motor_get_position_sensor(rotation_motors[i])

  left_arm_motors[SHOULDER_ROLL] = robot.getDevice("l_shoulder_pan_joint")
  left_arm_motors[SHOULDER_LIFT] = robot.getDevice("l_shoulder_lift_joint")
  left_arm_motors[UPPER_ARM_ROLL] = robot.getDevice("l_upper_arm_roll_joint")
  left_arm_motors[ELBOW_LIFT] = robot.getDevice("l_elbow_flex_joint")
  left_arm_motors[WRIST_ROLL] = robot.getDevice("l_wrist_roll_joint")
  for (i = SHOULDER_ROLL i <= WRIST_ROLL ++i)
    left_arm_sensors[i] = wb_motor_get_position_sensor(left_arm_motors[i])

  right_arm_motors[SHOULDER_ROLL] = robot.getDevice("r_shoulder_pan_joint")
  right_arm_motors[SHOULDER_LIFT] = robot.getDevice("r_shoulder_lift_joint")
  right_arm_motors[UPPER_ARM_ROLL] = robot.getDevice("r_upper_arm_roll_joint")
  right_arm_motors[ELBOW_LIFT] = robot.getDevice("r_elbow_flex_joint")
  right_arm_motors[WRIST_ROLL] = robot.getDevice("r_wrist_roll_joint")
  for (i = SHOULDER_ROLL i <= WRIST_ROLL ++i)
    right_arm_sensors[i] = wb_motor_get_position_sensor(right_arm_motors[i])

  left_finger_motors[LEFT_FINGER] = robot.getDevice("l_gripper_l_finger_joint")
  left_finger_motors[RIGHT_FINGER] = robot.getDevice("l_gripper_r_finger_joint")
  left_finger_motors[LEFT_TIP] = robot.getDevice("l_gripper_l_finger_tip_joint")
  left_finger_motors[RIGHT_TIP] = robot.getDevice("l_gripper_r_finger_tip_joint")
  for (i = LEFT_FINGER i <= RIGHT_TIP ++i)
    left_finger_sensors[i] = wb_motor_get_position_sensor(left_finger_motors[i])

  right_finger_motors[LEFT_FINGER] = robot.getDevice("r_gripper_l_finger_joint")
  right_finger_motors[RIGHT_FINGER] = robot.getDevice("r_gripper_r_finger_joint")
  right_finger_motors[LEFT_TIP] = robot.getDevice("r_gripper_l_finger_tip_joint")
  right_finger_motors[RIGHT_TIP] = robot.getDevice("r_gripper_r_finger_tip_joint")
  for (i = LEFT_FINGER i <= RIGHT_TIP ++i)
